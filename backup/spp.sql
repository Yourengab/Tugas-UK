...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2023 at 06:33 AM
...
INSERT INTO `tb_siswa` (`nis`, `nama`, `id_kelas`, `alamat`, `notelp`, `level`, `password`) VALUES
...
INSERT INTO `tb_user` (`id`, `level`) VALUES
(1, 'admin'),
(2, 'petugas'),
(3, 'siswa');
...
--
ALTER TABLE `tb_siswa`
  ADD CONSTRAINT `fk_kelas` FOREIGN KEY (`id_kelas`) REFERENCES `tb_kelas` (`idkelas`),
